...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // Attempt to initialize audio early, but DON'T await it.
    // This lets the app load while audio is prepared in the background.
...
async function startApp() {
    ...
    // Re-apply shaders now that the elements are visible and in the DOM correctly
    await preprocessCharacters();
}
window.startApp = startApp; // Expose to be called from intro-scene.js module
